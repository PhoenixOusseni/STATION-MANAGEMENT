            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('pompes.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nom"
                                        ...
                                        value="{{ old('nom') }}" required placeholder="Ex : Pompe 1">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="cuve_id" class="form-select @error('cuve_id') is-invalid @enderror" required>
                                        ...
                                        @foreach($cuves as $cuve)
                                            <option value="{{ $cuve->id }}" {{ old('cuve_id') == $cuve->id ? 'selected' : '' }}>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="numero_serie"
                                        ...
                                        value="{{ old('numero_serie') }}" placeholder="Optionnel">
