                    ...
                    <div class="dropdown float-end">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item"
                                    href="{{ route('users.index', ['role' => 'admin']) }}">Administrateurs</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('users.index', ['role' => 'gestionnaire']) }}">Gestionnaires</a></li>
                            <li><a class="dropdown-item"
                                    href="{{ route('users.index', ['role' => 'pompiste']) }}">Pompistes</a></li>
                        </ul>
                    </div>
                </div>
                <div class="card-body">
