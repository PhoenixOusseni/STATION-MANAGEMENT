                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            <h1 class="page-header-title">
                                ...
                                Nouvelle Entrée de Carburant
                            </h1>
                            <p>
                                <small>Enregistrez une nouvelle entrée de carburant dans le système.</small>
                            </p>
                        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('entrees.store') }}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" name="observation_jaugeage"
                                                    ...
                                                    value="{{ old('observation_jaugeage') }}"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="datetime-local" name="date_entree"
                                            ...
                                            value="{{ old('date_entree', date('Y-m-d\TH:i')) }}" required>
                                        @error('date_entree')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="numero_bon_livraison"
                                            ...
                                            value="{{ old('numero_bon_livraison') }}">
                                ...
                                <div class="alert alert-info">
                                    ...
                                    Le stock de la cuve sera automatiquement mis à jour après l'enregistrement.
                                </div>

                                <div class="mt-4">
                                    <button type="submit" class="btn btn-1">
                                        <i data-feather="save" class="me-2"></i>Enregistrer l'Entrée
                                    </button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p>
                                ...
                                Assurez-vous de sélectionner la bonne cuve de destination pour éviter les erreurs de stock.
                            </p>
                            <p>
                                <i data-feather="alert-triangle" class="me-2"></i>
                                Vérifiez que la quantité entrée n'excède pas la capacité restante de la cuve.
                            </p>
                            <p>
                                <i data-feather="check-circle" class="me-2"></i>
                                Si cette entrée est liée à une commande, sélectionnez-la pour un suivi optimal.
                            </p>
                            <hr>
                            <p>
                                <i data-feather="droplet" class="me-2"></i>
                                <strong>Jaugeage avant dépotage :</strong> Mesurez le niveau réel de la cuve avant de dépoter. L'écart (mesuré − théorique) sera automatiquement calculé et enregistré.
                            </p>
                        </div>
                    </div>
                </div>
