                        ...
                        <div class="col-md-6">
                            ...
                            <select name="station_id" class="form-select @error('station_id') is-invalid @enderror" required>
                                @foreach($stations as $station)
                                    <option value="{{ $station->id }}" {{ old('station_id', $cuve->station_id) == $station->id ? 'selected' : '' }}>
                                        {{ $station->nom }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="carburant_id" class="form-select @error('carburant_id') is-invalid @enderror" required>
                                @foreach($carburants as $carburant)
                                    <option value="{{ $carburant->id }}" {{ old('carburant_id', $cuve->carburant_id) == $carburant->id ? 'selected' : '' }}>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="capacite_max" class="form-control @error('capacite_max') is-invalid @enderror"
                                   value="{{ old('capacite_max', $cuve->capacite_max) }}" min="0" step="0.01" required>
                            @error('capacite_max')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="stock_actuel" class="form-control @error('stock_actuel') is-invalid @enderror"
                                   value="{{ old('stock_actuel', $cuve->stock_actuel) }}" min="0" step="0.01" required>
                            @error('stock_actuel')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="stock_min" class="form-control @error('stock_min') is-invalid @enderror"
                                   value="{{ old('stock_min', $cuve->stock_min) }}" min="0" step="0.01" required>
                            @error('stock_min')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
